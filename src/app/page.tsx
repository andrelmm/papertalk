    ...
    <>
      <MaxWidthWrapper
        ...
        <div className='mx-auto mb-4 flex max-w-fit items-center justify-center space-x-2 overflow-hidden border border-gray-200 bg-white px-7 py-2 shadow-md backdrop-blur transition-all hover:border-gray-300 hover:bg-white/50 rounded-full'>
          <p className='text-sm font-semibold text-gray-700'>DocuChat</p>
        </div>
        <h1 className='max-w-4xl text-5xl font-bold md:text-6xl lg:text-7xl'>
          Converse com os seus <span className='text-blue-600'>documentos</span> em segundos.
        </h1>
        <p className='mt-5 max-w-prose'>
          DocuChat é uma ferramenta que permite que você converse com seus documentos. Basta enviar um arquivo e começar a conversar com ele.
        </p>
